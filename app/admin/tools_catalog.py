...
ADMIN_TOOLS: Tuple[AdminTool, ...] = (
    ...
    AdminTool(
        key="event-log",
        title="Critical logs",
        summary="Live stream of checkout, fulfillment, and security failures.",
        icon="fa-solid fa-bolt",
    ...
    AdminTool(
        ...
        summary="Phone-friendly playbooks when the site has a critical issue.",
        icon="fa-solid fa-kit-medical",
        endpoint="admin:emergency-desk",
        roles=(ROLE_ADMIN, ROLE_SUPPORT),
        badge="Ops",
    ),
    AdminTool(
