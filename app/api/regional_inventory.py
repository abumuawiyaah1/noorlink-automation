...
REGIONAL_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "europe": {
        "name": "Europe",
        "currency": "USD",
        # Telna Europe Bundle (35 countries) — 1/3/5/10 GB ladder.
        "plans": {
            "basic": {
                "name": "Basic",
                "data": "1GB",
                ...
                "price": 9.99,
                "fulfillment": {
                    "catalog_key": "eu-1gb-5",
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7fee7",
                    "provider_slug": "telna-europe-1gb-5d",
                    "wholesale_cents": 150,
                },
            },
            "standard": {
                ...
                "popular": True,
                "fulfillment": {
                    "catalog_key": "eu-3gb-7",
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7fefc",
                    "provider_slug": "telna-europe-3gb-7d",
                    "wholesale_cents": 325,
                },
            },
            "plus": {
                ...
                "price": 19.99,
                "fulfillment": {
                    "catalog_key": "eu-5gb-15",
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7fedf",
                    "provider_slug": "telna-europe-5gb-15d",
                    "wholesale_cents": 500,
                },
            },
            "premium": {
                ...
                "fulfillment": {
                    ...
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7fed8",
                    "provider_slug": "telna-europe-10gb-30d",
                    "wholesale_cents": 900,
                },
            },
            "family": {
    ...
    "asia-pacific": {
        "name": "Asia Pacific",
        "currency": "USD",
        # Telna Asia Bundle 2 (20 countries; no Australia — see australia template).
        "plans": {
            "basic": {
                "name": "Basic",
                "data": "1GB",
                ...
                "price": 12.99,
                "fulfillment": {
                    "catalog_key": "as-1gb-5",
                    "provider": "telna",
                    "provider_sku": "690b2b5f7aff111b7539f7c2",
                    "provider_slug": "telna-asia2-1gb-5d",
                    "wholesale_cents": 275,
                },
            },
            "standard": {
                ...
                "popular": True,
                "fulfillment": {
                    "catalog_key": "as-3gb-7",
                    "provider": "telna",
                    "provider_sku": "690b2b5f7aff111b7539f7c1",
                    "provider_slug": "telna-asia2-3gb-7d",
                    "wholesale_cents": 725,
                },
            },
            "plus": {
                ...
                "price": 27.99,
                "fulfillment": {
                    "catalog_key": "as-5gb-15",
                    "provider": "telna",
                    "provider_sku": "690b2b5e7aff111b7539f7c0",
                    "provider_slug": "telna-asia2-5gb-15d",
            ...
            "premium": {
                ...
                "fulfillment": {
                    ...
                    "provider": "telna",
                    "provider_sku": "690b2b5e7aff111b7539f7bf",
                    "provider_slug": "telna-asia2-10gb-30d",
                    "wholesale_cents": 2125,
                },
            },
            "family": {
                "name": "Family Bundle",
    ...
    "middle-east": {
        "name": "Middle East",
        "currency": "USD",
        # Telna Middle East Bundle (15 countries). Saudi single-country/Umrah stays Access.
        "plans": {
            "basic": {
                "name": "Basic",
                "data": "1GB",
    ...
    "north-america": {
        "name": "North America",
        "currency": "USD",
        # Telna North America Bundle (USA + Canada only). Mexico uses mexico template.
        "plans": {
            "basic": {
                "name": "Basic",
                "data": "1GB",
                ...
                "price": 9.99,
                "fulfillment": {
                    "catalog_key": "na-1gb-5",
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7fff2",
                    "provider_slug": "telna-na-1gb-5d",
                    "wholesale_cents": 250,
                },
            },
            "standard": {
                ...
                "popular": True,
                "fulfillment": {
                    "catalog_key": "na-3gb-7",
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc80043",
                    "provider_slug": "telna-na-3gb-7d",
                    "wholesale_cents": 660,
                },
            },
            "plus": {
                ...
                "price": 24.99,
                "fulfillment": {
                    "catalog_key": "na-5gb-15",
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7fffa",
                    "provider_slug": "telna-na-5gb-15d",
                    "wholesale_cents": 1000,
                },
            },
            "premium": {
                ...
                "fulfillment": {
                    ...
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc80016",
                    "provider_slug": "telna-na-10gb-30d",
                    "wholesale_cents": 1800,
                },
            },
            "family": {
                "name": "Family Bundle",
    ...
    "mexico": {
        "name": "Mexico",
        "currency": "USD",
        # Telna single-country Mexico (gap-fill — not in NA Bundle).
        "plans": {
            "basic": {
                "name": "Basic",
                "data": "1GB",
                ...
                "price": 9.99,
                "fulfillment": {
                    "catalog_key": "mx-1gb-5",
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7ffaa",
                    "provider_slug": "telna-mexico-1gb-5d",
                    "wholesale_cents": 300,
                },
            },
            "standard": {
                ...
                "popular": True,
                "fulfillment": {
                    "catalog_key": "mx-3gb-7",
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7ffcc",
                    "provider_slug": "telna-mexico-3gb-7d",
                    "wholesale_cents": 750,
                },
            },
            "plus": {
                ...
                "price": 24.99,
                "fulfillment": {
                    "catalog_key": "mx-5gb-15",
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7fff5",
                    "provider_slug": "telna-mexico-5gb-15d",
                    "wholesale_cents": 1100,
                },
            },
            "premium": {
                ...
                "fulfillment": {
                    ...
                    "provider": "telna",
                    "provider_sku": "66b5db0b899f794eccc7ffb4",
                    "provider_slug": "telna-mexico-10gb-30d",
