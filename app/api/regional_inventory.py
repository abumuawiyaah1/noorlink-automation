...
REGIONAL_TEMPLATES: Dict[str, Dict[str, Any]] = {
    ...
    "north-america": {
        "name": "North America",
        "currency": "USD",
        # Zesimo NA regional (USA + Canada + Mexico).
        "plans": {
            "basic": {
                "name": "Basic",
                "data": "1GB",
...
REGIONAL_PRODUCTS: Dict[str, Dict[str, Any]] = {
    ...
    "regional-north-america": {
        ...
        "hero_tagline": "USA, Canada, and Mexico on one eSIM — no plan swap at the border.",
        "countries": [
            "United States",
            "Canada",
            "Mexico",
    ...
    "regional-global": {
        ...
        "flag_emoji": "🌐",
        "template_key": "global",
        "hero_tagline": "193 countries on one plan — for long-haul and multi-region journeys.",
        "countries": [
            "United States",
            "Canada",
            "United Kingdom",
