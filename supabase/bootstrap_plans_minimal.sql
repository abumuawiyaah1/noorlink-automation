...
from (values
  ...
  ('saudi-arabia', 'Lite Explorer 5GB', 5::numeric, 30, 7.22, 'AUTOMATED', 'FIXED', false, true, 10, 'middle-east'),
  ...
  ('saudi-arabia', 'Unlimited Devotion 50GB', 50::numeric, 30, 59.90, 'MANUAL', 'UNLIMITED', false, true, 30, 'middle-east'),
  ('saudi-arabia', 'Family Share 50GB', 50::numeric, 30, 59.90, 'MANUAL', 'FLEXIBLE', false, true, 40, 'middle-east'),
